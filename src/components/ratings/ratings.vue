    ...
    <div class="ratings" ref="ratings">
      <transition>
        <div class="ratings-content">
          ...
          @ratingtype-select="rateTypeSelect" @content-toggle="contentToggle"></ratingselect>
  ...
  .ratings
    ...
    .overview
      ...
      .overview-left
        ...
        text-align: center
        @media only screen and (max-width: 320px) // 处理在iphone5下宽度不够折行问题
          flex: 0 0 120px
          width: 120px
        .score
          margin-bottom: 6px
